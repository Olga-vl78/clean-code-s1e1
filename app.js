...
var addButton = document.querySelector(".tasks__add-btn");//first button
...
var createNewTaskElement = function (taskString) {
    ...
    label.className = 'tasks__task tasks-label';

    editInput.type = "text";
    editInput.className = "tasks__task tasks__input-text";

    editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
    editButton.className = "task-list__button edit-button";

    deleteButtonImg.src = "./remove.svg";
    deleteButtonImg.className = "remove-pic"
    deleteButtonImg.alt = "click here to remove text";

    deleteButton.className = "task-list__button delete-button";
...
var editTask = function () {
    ...
    var label = listItem.querySelector(".tasks-label");
